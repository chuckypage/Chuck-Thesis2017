...
var image = { // back and front images
  'back': { 'url':'skinny.jpeg', 'img':null },
	'front': { 'url':'overweight.jpeg', 'img':null }
...
var image = { // back and front images
  'back': { 'url':'blonde.jpeg', 'img':null },
	'front': { 'url':'braids.jpeg', 'img':null }
 ...
 */
function recompositeCanvases() {
	var main = document.getElementById('secondcanvas');
	var tempctx = canvas.temp.getContext('2d');
	var mainctx = main.getContext('2d');
...
var image = { // back and front images
  'back': { 'url':'whitegirl.jpg', 'img':null },
	'front': { 'url':'blackwoman.jpg', 'img':null }
 ...
 */
function recompositeCanvases() {
	var main = document.getElementById('thirdcanvas');
	var tempctx = canvas.temp.getContext('2d');
	var mainctx = main.getContext('2d');
...
var image = { // back and front images
  'back': { 'url':'blue.jpeg', 'img':null },
	'front': { 'url':'brown.jpeg', 'img':null }
 ...
 */
function recompositeCanvases() {
	var main = document.getElementById('fourthcanvas');
	var tempctx = canvas.temp.getContext('2d');
	var mainctx = main.getContext('2d');
...
var image = { // back and front images
  'back': { 'url':'whitemakeup.jpg', 'img':null },
	'front': { 'url':'wocmakeup.jpg', 'img':null }
 ...
 */
function recompositeCanvases() {
	var main = document.getElementById('fifthcanvas');
	var tempctx = canvas.temp.getContext('2d');
	var mainctx = main.getContext('2d');
 ...
 */
function setupCanvases() {
	var c = document.getElementById('fifthcanvas');
	// set the width and height of the main canvas from the first image
	// (assuming both images are the same dimensions)
	c.width = image.back.img.width;
	c.height = image.back.img.height;
...
var image = { // back and front images
  'back': { 'url':'lighter.png', 'img':null },
	'front': { 'url':'beautiful.jpg', 'img':null }
 ...
 */
function recompositeCanvases() {
	var main = document.getElementById('sixthcanvas');
	var tempctx = canvas.temp.getContext('2d');
	var mainctx = main.getContext('2d');
 ...
 */
function setupCanvases() {
	var c = document.getElementById('sixthcanvas');
	// set the width and height of the main canvas from the first image
	// (assuming both images are the same dimensions)
	c.width = image.back.img.width;
	c.height = image.back.img.height;
